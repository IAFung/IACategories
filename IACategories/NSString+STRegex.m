...
- (NSString *)isValidPwd
{
    ...
    if (![self isValidLetterAndDigtal]) {
        return @"密码只支持数字和字母";
    }
    return @"";
...
- (BOOL)isValidPhoneNum
{
    ...
    return [self isValidateWithRegex:phoneRegex];
}
...
- (BOOL)isValidUrl
{
    ...
    return [self isValidateWithRegex:urlRegex];
}
...
- (BOOL)isValidDigtal
{
    NSString *digtalRegex = @"[0-9]*";
    return [self isValidateWithRegex:digtalRegex];
}
...
- (BOOL)isValidLetter
{
    ...
    return [self isValidateWithRegex:letterRegex];
}
/** 字母和数字*/
- (BOOL)isValidLetterAndDigtal
{
...
- (BOOL)isValidIP;
{
    ...
    BOOL rc = [self isValidateWithRegex:regex];
        ...
        firstCannotBeDigtal:(BOOL)firstCannotBeDigtal;
{
    ...
    NSString *regex = [NSString stringWithFormat:@"%@[%@A-Za-z0-9_]{%d,%d}", first, hanzi, (int)(minLength-1), (int)(maxLength-1)];
    return [self isValidateWithRegex:regex];
}
